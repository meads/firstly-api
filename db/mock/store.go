...
// Source: github.com/meads/firstly-api/db/sqlc (interfaces: Store)
...
func (m *MockStore) CreateImage(arg0 context.Context, arg1 string) (db.Image, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListImages(arg0 context.Context) ([]db.Image, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Tx(arg0 context.Context, arg1 func(*db.Queries, *interface{}) (interface{}, error)) (interface{}, error) {
	m.ctrl.T.Helper()
